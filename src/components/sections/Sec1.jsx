    ...
    <div className="relative overflow-hidden border-purple-dark border-opacity-40 border-t-[1px] text-purple-dark">
      ...
      <div className="grid 2xl:grid-cols-[64px,auto,64px] 3xl:grid-cols-[auto,2024px,auto]">
        <div className="grid w-full grid-cols-1 lg:grid-cols-2 xl:col-start-2 min-h-[1050px] xs:min-h-[1000px] lg:min-h-[600px] 2xl:min-h-[700px] h-[calc(100vh-90px)] lg:h-[calc(100vh-75px)] xl:h-[calc(100vh-90px)]">
            ...
            <div className="flex w-full flex-col gap-y-4 md:gap-y-6">
              ...
              <div className="space-y-4 md:space-y-6 max-w-full">
                <div className="space-y-4">
                  <h2 className="font-sans text-[34px] leading-[1.05] tracking-tight font-extrabold ">
                ...
                <div className="space-y-4">
                  <p className="font-sans leading-tight text-sm font-bold">
                  ...
                  <div className="grid max-w-full grid-cols-1 gap-3 xl:grid-cols-2">
                    <div className="flex space-x-4">
                      ...
                      <div className="font-sans leading-tight text-sm font-medium">
          ...
          <div className="row-start-1 h-full min-h-[350px] w-full overflow-hidden border-b-[1px] border-eggplant border-opacity-40 lg:border-b-0 2xl:border-r-[1px]">
